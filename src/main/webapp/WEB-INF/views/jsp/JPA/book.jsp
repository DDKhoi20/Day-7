                ...
                <form:form action="${action}" method="post" modelAttribute="book">
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="bookDetails.price" type="number" class="form-control" placeholder="Price" required="true" min="1" step="any"/>
                        </div>

                        <div class="form-group">
                            <label class="control-label">Number of Pages (*)</label>
                            <form:input path="bookDetails.numberOfPage" type="number" class="form-control" placeholder="Number of Pages" required="true"/>
                        </div>
